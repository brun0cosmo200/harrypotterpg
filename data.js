...
const ARVORE_HABILIDADES = {
  ...
  30: [
    ...
    { id: "ressurgencia", nome: "Ressurgência",    icon: "🔱", desc: "Ao vencer uma batalha com menos de 20% HP, cura para 50% do HP máximo", tipo: "ressurgencia", valor: 0.50 },
  ],
};
...
const LOJA_ITENS = [
  ...
  { id: "giro_mascote",  nome: "Giro de Mascote",          icon: "🎠", preco: 1200, desc: "Ganha 1 giro extra na roleta de mascote", tipo: "mascote", nivelMin: 3 },
...
const MASCOTES = [
  // ── Comum ──
  { id:'nox',         nome:'Nox',           emoji:'🦉', raridade:'Comum',    peso:35, desc:'+8 HP máximo',                         bonus:{ hp:8 } },
  { id:'crookshanks', nome:'Crookshanks',   emoji:'🐱', raridade:'Comum',    peso:30, desc:'+10 HP máximo',                        bonus:{ hp:10 } },
  { id:'scabbers',    nome:'Crostas',       emoji:'🐀', raridade:'Comum',    peso:25, desc:'+6 HP e +5 MP máximos',                bonus:{ hp:6, mp:5 } },
  { id:'trevor',      nome:'Trevor',        emoji:'🐸', raridade:'Comum',    peso:20, desc:'+5% de ouro extra em batalhas',         bonus:{ ouroPct:0.05 } },
  { id:'pigwidgeon',  nome:'Pigwidgeon',    emoji:'🐦', raridade:'Comum',    peso:18, desc:'+8 MP máximo',                         bonus:{ mp:8 } },

  // ── Raro ──
  { id:'buckbeak',    nome:'Bico de Aço',   emoji:'🦅', raridade:'Raro',     peso:12, desc:'+20 HP máximo',                        bonus:{ hp:20 } },
  { id:'aragog_jr',   nome:'Aragog Jr.',    emoji:'🕷️', raridade:'Raro',     peso:10, desc:'+4% de chance crítica',                bonus:{ crit:0.04 } },
  { id:'thestral',    nome:'Thestral',      emoji:'🦇', raridade:'Raro',     peso:9,  desc:'+15 HP e +8 MP máximos',               bonus:{ hp:15, mp:8 } },
  { id:'norbert',     nome:'Norberto',      emoji:'🐉', raridade:'Raro',     peso:8,  desc:'+6% de ouro extra em batalhas',        bonus:{ ouroPct:0.06 } },

  // ── Épico ──
  { id:'nagini',      nome:'Nagini',        emoji:'🐍', raridade:'Épico',    peso:5,  desc:'+10% de ouro e +5 HP máximos',         bonus:{ ouroPct:0.10, hp:5 } },
  { id:'padfoot',     nome:'Padfoot',       emoji:'🐺', raridade:'Épico',    peso:4,  desc:'+30 HP máx e +6% crítico',             bonus:{ hp:30, crit:0.06 } },
  { id:'crumple_horn',nome:'Snorffle',      emoji:'🦄', raridade:'Épico',    peso:3,  desc:'+20 MP máx e +10% XP extra',           bonus:{ mp:20, xpPct:0.10 } },
  { id:'basilisco_jr',nome:'Basilisco Jr.', emoji:'🐊', raridade:'Épico',    peso:3,  desc:'+7% de crítico',                       bonus:{ crit:0.07 } },

  // ── Lendário ──
  { id:'fenix',       nome:'Fênix',         emoji:'🕊️', raridade:'Lendário', peso:2,  desc:'Ressurge com 40 HP (1x/batalha)',      bonus:{ ressurgirMascote:40 } },
  { id:'patronus_g',  nome:'Patrono',       emoji:'🌟', raridade:'Lendário', peso:1,  desc:'+40 HP, +15 MP e +8% crítico',         bonus:{ hp:40, mp:15, crit:0.08 } },
];
